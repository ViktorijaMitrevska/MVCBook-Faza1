...
namespace MVCBook.Controllers
{
    public class BookGenresController : Controller
    {
        ...
        public BookGenresController(MVCBookContext context)
        {
            _context = context;
        }
        ...
        {
            var mVCBookContext = _context.BookGenre.Include(b => b.Book).Include(b => b.Genre);
        ...
        public async Task<IActionResult> Create([Bind("Id,BookId,GenreId")] BookGenre bookGenre)
        {
            ...
            ViewData["GenreId"] = new SelectList(_context.Genre, "Id", "GenreName", bookGenre.GenreId);
            return View(bookGenre);
        }
